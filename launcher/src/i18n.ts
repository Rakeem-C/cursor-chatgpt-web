...
const en = {
  ...
  stepAccountBody: "Sign in through the dedicated system Chrome/Chromium window. An already-open chatgpt.com tab in everyday Chrome is not reused. Only allowlisted ChatGPT state is imported into this launcher's private profile.",
  signIn: "Open sign in",
...
const zh: Record<keyof typeof en, string> = {
  ...
  stepAccountBody: "请在专用的系统 Chrome/Chromium 窗口中登录。日常 Chrome 里已经打开的 chatgpt.com 标签页不会被复用。只有经过验证的 ChatGPT 会话会导入此启动器的私有配置。",
  signIn: "打开登录",
