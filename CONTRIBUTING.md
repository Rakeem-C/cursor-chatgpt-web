...
- MCP delegation is the supported path. The model picker is experimental until real Cursor fixtures exist.
- `chatgpt-web-high` is GPT-5.6 Sol High. The selected ID is authoritative.
